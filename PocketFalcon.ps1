...
Write-Host "Available options to change are:"
Write-Host "[1] Status"
Write-Host "[2] Assigned To"
Write-Host "[3] Add a comment"
...
if ($choice -eq 1){
  ...
  Write-Host "Status options are:"
  Write-Host "[1] New"
  Write-Host "[2] In Progress"
  Write-Host "[3] True Positive"
  Write-Host "[4] False Positive"
  Write-Host "[5] Ignored"
  Write-Host "[6] Closed"
  Write-Host "[7] Reopened"
  $choice2 = Read-Host "Choose a status"
